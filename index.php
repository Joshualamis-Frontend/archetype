...
.custom-auth-modal .swal2-html-container {
    color: rgb(190, 18, 18);
    font-size: 1rem;
    margin-bottom: 1.25rem;
}
...
.custom-auth-modal-cancel {
    background-color: rgb(192, 142, 34) !important;
    color: rgb(206, 24, 24) !important;
...
.custom-auth-modal-cancel:hover {
    background-color: rgb(255, 235, 123) !important;
    border-color: #d1d7dc !important;
    transform: translateY(-1px) !important;
    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1) !important;
}

.custom-auth-modal-confirm {
    background-color: rgb(192, 142, 34) !important;
    color: rgb(202, 12, 12) !important;
    padding: 8px 18px !important;
    border-radius: 20px !important;
    font-weight: 500 !important;
    font-size: 0.875rem !important;
...
.custom-auth-modal-confirm:hover {
    background-color: rgb(255, 235, 123) !important;
    transform: translateY(-1px) !important;
}
